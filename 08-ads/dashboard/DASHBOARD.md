...
**Dernière mise à jour : 2026-06-17 18h00 (J15 partiel · ⛔ CAMPAIGN_PAUSED ~293h · 12e jour · J14 FINAL=55s ✅ · J15: 38s · 7ème spike CONFIRMÉ · ⚠️ 4ème ATC direct · 4/4 checkout abandonné · Meta API OK — PRIORITÉ #0: fixer checkout avant relance)**
...
## 🆕 CE QUI A CHANGÉ depuis run J15 12h (17/06)

1. **J15 partiel 18h = 38 sessions** (vs 23 à 12h — +15s). **7ème spike CONFIRMÉ** (38s dépasse largement la baseline 5–8s/j). 1 ATC + 1 checkout inchangés depuis 8h — les 15 nouvelles sessions n'ont pas généré de nouvel ATC.
2. **J14 FINAL = 55 sessions** ✅ confirmé API (inchangé — pas de correction).
3. **Meta API opérationnelle** ce run (erreur OTID résolue) — 2 campagnes `PAUSED` confirmées API (~293h · 12e jour).
...
| Sessions total | 21 | 5–63/j | **55 ✅** | **38 (partiel 18h)** |
...
Sessions total   :    516    (J1→J14 FINAL=478 + J15 partiel 18h: 38s)
ATC social       :      1    (J3) — coût/ATC = 27,37 €
ATC direct       :      4    (J8:2 + J10:1 + J15:1 · trafic warm · 0 commande · 4/4 abandonné checkout)
Commandes        :      0    — 0,00 € CA
Spikes pause     :      7    (J8=34 · J10=34 · J11=63 · J12=55 · J13=39 · J14=55 · J15=38@partiel 18h)
```
