# Packaging & Direction Artistique — Barky

> **Source de vérité :** [`BARKY_CERVEAU.md`](../BARKY_CERVEAU.md) §9. Ce fichier en est l'extrait opérationnel.
...
> Coût total unboxing : ~2 €. Retour : ~200 € en rétention + UGC. Le ratio le plus rentable du business.

---

## Mentions légales packaging (obligatoires)

- ✅ **"Aliment complémentaire pour chiens"** (mention légale obligatoire)
...
Voir [`04-legal/compliance.md`](../04-legal/compliance.md) pour le détail réglementaire.

---

## Prompts image IA — production Ads
